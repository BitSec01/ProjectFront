<template>
  <div id="contactModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Contact: {{ contact.name }} {{ contact.middlename }} {{ contact.lastname }}</h4>
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="class" v-model="contact.company_id">
              </div>
            </div>
            <div class="col-md-5">
              <div class="form-group">
                <label for="field-1" class="control-label">Name</label>
                <input type="text" class="form-control" id="field-1" v-model="contact.name">
              </div>
            </div>
            <div class="col-md-5">
              <div class="form-group">
                <label for="field-2" class="control-label">Lastname</label>
                <input type="text" class="form-control" id="field-2" v-model="contact.lastname">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone" v-model="contact.phone">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="date" class="form-control" id="last_contacted" v-model="contact.last_contacted">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="email" class="control-label">Gecontacteerd door</label>
                <input type="text" class="form-control" id="contacted_by" v-model="contact.contacted_by">
              </div>
            </div>
          </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger waves-effect waves-light" v-on:click="Delete()">Delete this contact</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    SubmitModal() {
      ...
      Axios.patch('http://localhost:80/contact/' + this.contact.id, {
    ...
    Delete() {
      Axios.delete('http://localhost:80/contact/' + this.contact.id).then((response) => {
        console.log(this.contact);
        console.info('Contact succesfully deleted');
        console.log(response.data);
      }).catch((err) => {
        console.warn(err);
        alert('Error has occured check log');
